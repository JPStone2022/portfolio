...
python manage.py management/commands/import_data data/topics.csv --model_type topics --update
python manage.py management/commands/import_data data/skills.csv --model_type skills --update
