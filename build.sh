...
python manage.py migrate --no-input # && python manage.py import_data data/skills.csv --model_type skills --update && python manage.py import_data data/topics.csv --model_type topics --update
